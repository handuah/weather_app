            ...
            ? SingleChildScrollView(
                child: Container(
                 ...
                 Positioned(
                  ...
                  child: ListView.separated(
                     padding: EdgeInsets.symmetric(horizontal: size.width * 0.02, vertical: size.height * 0.024,),
                    itemBuilder: (context, index){
                      return  GestureDetector(
                        onTap:(){
                          setState(() {
                            _cityCountryCon.text = '${autoCompleteList[index]['name']}, ${autoCompleteList[index]['country']}';
                            searching = false;
                          });
                        },
                        child: Row(
                    ...
                    Text('${autoCompleteList[index]['name']}, ${autoCompleteList[index]['country']}',
                     style: TextStyle(
                                          color: Colors.black,
            ...
            : Center(
                child: Column(
                  ...
                  children:  [
                    ...
                    Text('Getting Weather Data',   style: TextStyle(
                                          color: Colors.black,
                                          fontSize: size.height * 0.028,
                                          fontWeight: FontWeight.normal,
                                        ),),
